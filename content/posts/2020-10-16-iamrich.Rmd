...
ggplot(apps, aes(x=precio)) +
  ...
  theme_minimal() +
  labs(y = "", x = "price") +
  theme(plot.background = element_rect(fill = "#39424e", color = "#39424e"),
        panel.background = element_rect(fill = lighten("#39424e", 1.4), color = lighten("#39424e", 1.4)),
...
ggplot(apps, aes(x=precio)) +
  ...
  theme(plot.background = element_rect(fill = "#39424e", color = "#39424e"),
        ...
        panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank(),
        panel.grid.major.y = element_line(size = 0.1), panel.grid.minor.y = element_line(size = 0.1),
        strip.background = element_rect(fill = alpha(lighten("#39424e", 1.4), 1), color = lighten("#39424e", 1.4)))
```
